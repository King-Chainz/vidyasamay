...
const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://vidyasamay.onrender.com/api'
...
export const timetableAPI = {
  generate: (data) => 
    apiClient.post('/generate', data, { timeout: 60000 }), // 60 second timeout for generation
